...
import static com.medi.MedicalApplication.security.SecurityConstants.SING_UP_URLS;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(AuthenticationManagerBuilder authenticationManagerBuilder) throws Exception {
       authenticationManagerBuilder.userDetailsService(customLoginDetailsService).passwordEncoder(bCryptPasswordEncoder);
    }
